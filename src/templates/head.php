...
<meta name="zone_latitude" content="<? echo ENLIST_ZONE_LATITUDE ?>">
<meta name="zone_longitude" content="<? echo ENLIST_ZONE_LONGITUDE ?>">
<meta name="zone_radius" content="<? echo ENLIST_ZONE_RADIUS ?>">
